...
use crate::{record::Precision, ParseError};
...
pub enum Property {
    ...
    /// Unknown property. This only exists for forward compatibility and using it is not
    /// recommended as the property you are using could be move to the known properties in a
    /// future release.
